...
function Forms() {
    ...
    const [PrevBtn, setBtnStyle] = useState('none')
    const [NextBtn, setBtnStyle] = useState('block')
    const [Submit, setBtnStyle] = useState('none')
   ...
   const clickHandler = (e) => {
    ...
    return (
        <Conainer  className="container">
          ...
          <button tabIndex={1} onClick={clickHandler} style={{display={}}}>Click me previous</button>
          <button tabIndex={2} onClick={clickHandler} >Click me next</button>
          <button tabIndex={2} onClick={clickHandler} >Click me next</button>
