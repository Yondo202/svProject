        ...
        <Conainer  className="container">
          ...
          <div className="Header">
              ...
              <div className="pageCountPAr">
                <div style={{background:`${background}`}} tabIndex={1} onClick={clickHandler} className=" One">1</div>
                <div className="line"></div>
                <div style={{background:`${background}`}} tabIndex={2} onClick={clickHandler} className=" Two">2</div>
              </div>
          </div>
