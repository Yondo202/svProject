                    ...
                    >
                        ...
                        <form onSubmit={handleClick}>
                            <div className="FormItems">
                                ...
                                <input className="getinput" type="text" onChange={handleChange} name="parent" />
                            </div>
                            <div className="FormItems">
                                <label>Нэр:</label>
            ...
            <div className="ParentInfo">
                <div className="colOne">
                    <div className="main-info">
                        ...
                        <input className="getinput val" type="text" value={Value} onChange={handleChange} name="parent" />
                    </div>
                    <div className="main-info">
