   ...
   const clickHandler = (e) => {
    ...
    return (
        <Conainer  className="container">
          ...
          <div className={`side${myIndex} style${myIndex}`} style={{transform:`scale(${scale})`, display:`${display}`}}>
           <Form1 />
          </div>
          <div className={`side${myIndex2} style${myIndex}`} style={{transform:`scale(${scale2})`,display:`${display2}`}}>
           <Form2 />
          </div>
