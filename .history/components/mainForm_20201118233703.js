    ...
    return (
        <Conainer  className="container">
          ...
          <div className="btnPar">
            ...
            <button tabIndex={2} onClick={clickHandler} style={{display:`${NextBtn}`, justifySelf:"end", alignSelf:'flex-end'}}>Click me next</button>
            <button tabIndex={3} onClick={clickHandler} style={{display:`${Submit}`, justifySelf:"end"}}>Илгээх</button>
          </div>
