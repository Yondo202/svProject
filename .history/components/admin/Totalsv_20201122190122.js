...
function Totalsv(props) {
    var today = new Date();
    const [dateFilter, setdateFilter] = useEffect("")
    // const date 
    // date = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate();
    console.log(today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate(), "date irleee")
                                    ...
                                    <div className="userInf">
                                        ...
                                        <div className="InfSmPar">
                                            ...
                                            <div className="bonusInf">
                                                ...
                                                <span><RiMailSendLine />{el.createdAt.slice(0,10)}</span>
                                            </div>
                                        </div>
