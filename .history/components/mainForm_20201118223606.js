    ...
    return (
        <Conainer  className="container">
          ...
          <div className="formsPAr">
            <div className={`side${myIndex} style${myIndex}`} style={{transform:`scale(${scale})`, left:`${transition}` }}>
            <Form1 />
            </div>
            <div className={`side${myIndex2} style${myIndex}`} style={{transform:`scale(${scale2})`, left:`${transition2}`}}>
            <Form2 />
            </div>
          </div>
