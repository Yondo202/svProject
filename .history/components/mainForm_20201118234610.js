    ...
    return (
        <Conainer  className="container">
          ...
          <div className="btnPar">
            <button tabIndex={1} onClick={clickHandler} style={{ transform:`scale(${PrevBtn})`}}> Click me previous</button>
            <button tabIndex={2} onClick={clickHandler} style={{ transform:`scale(${NextBtn})`}}>Click me next</button>
            <button tabIndex={3} onClick={clickHandler} style={{ transform:`scale(${Submit})`}}>Илгээх</button>
          </div>
