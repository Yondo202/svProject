   ...
   const clickHandler = (e) => {
    ...
    return (
        <Conainer  className="container">
          ...
          <button tabIndex={2} onClick={clickHandler} style={{display:`${nextBtn}`}}>Click me next</button>
          <button tabIndex={2} onClick={clickHandler} style={{display:`${Submit}`}}>Click me next</button>
