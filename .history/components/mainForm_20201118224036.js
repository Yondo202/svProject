    ...
    return (
        <Conainer  className="container">
          ...
          <div className="formsPAr">
            <div className={`side${myIndex} style${myIndex}`} style={{ left:`${transition}`,right:`${transition2}` }}>
            <Form1 />
            </div>
            <div className={`side${myIndex2} style${myIndex}`} style={{ left:`${transition2}`,right:`${transition}`}}>
            <Form2 />
            </div>
          </div>
