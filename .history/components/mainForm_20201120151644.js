...
function Forms() {
   ...
   const clickHandler = (e) => {
      ...
      const handleClick = async (e) =>{
        ...
        let final = {};
        let addClass = document.querySelectorAll('.getinput').addClass('dadada');
        ...
        //     el.value = "red";
        //     // console.log(el.value.lenght, 'hevelleee')
        //   }else if(el.value !== 0){
        //     final[field] = value
        //   }
        // })
        ...
        arr.map(element=>{
            ...
            console.log(element.value.length, 'hevelleee')
            if(element.value.length === 0 ){
              element.value = "red";
              // console.log(element.value.lenght, 'hevelleee')
