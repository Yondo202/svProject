                    ...
                    <div className="main-info">
                        ...
                        <div className="val">
                            <select className="getinput childs" name="year" placeholder="сүно">
                                ...
                                <option value="women">1999</option>
                                <option value="women">1998</option>
                                <option value="women">1997</option>
                                <option value="women">1996</option>
                                <option value="women">1995</option>
                                <option value="women">1994</option>
                                <option value="women">1993</option>
                                <option value="women">1992</option>
                                <option value="women">1991</option>
                                <option value="women">1990</option>
                            </select>
                ...
                <div className="colOne">
                    ...
                    <label className="B">Ам бүл (тоо):</label>
                        <select className="getinput val" name="family" placeholder="сүно">
                            ...
                            <option value="women">3</option>
                            <option value="women">4</option>
                            <option value="women">5</option>
                            <option value="women">6</option>
                            <option value="women">7</option>
                    </select>
