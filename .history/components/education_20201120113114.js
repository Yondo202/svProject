            ...
            <div className="ParentInfo">
                <div className="colOne">
                    <div className="main-info">
                        <label className="B">Боловсролын түвшин:</label>
                        <input className="getinput val" placeholder="түвшин" type="text" name="education" />
                    </div>
                    <div className="main-info">
                        <label className="B">Улс:</label>
                        <input className="getinput val" placeholder="Нэр" type="text" name="country" />
                    </div>
                    <div className="main-info">
